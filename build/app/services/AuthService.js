...
var register = function register(user) {
  return new Promise( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
      var email, password, rest, token, response, _user;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              email = user.email, password = user.password, rest = _objectWithoutProperties(user, _excluded);
              token = null;
              _context.next = 5;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              ...
              isChecked = response && _bcryptjs["default"].compareSync(password, response.password);
              token = isChecked ? _jsonwebtoken["default"].sign({
                id: response.id,
